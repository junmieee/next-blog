    ...
    return (
        <div className=' w-full py-4 hover:drop-shadow-basic group'>
            <Link href={'/blog/' + post.slug} className="hover:drop-shadow-base">
                <p className="text-2xl font-bold text-gray-900 dark:text-gray-100">{post.title}</p>
                <p className="text-tertiary mt-1 text-gray-600 dark:text-gray-400">{post.description}</p>
            </Link>
